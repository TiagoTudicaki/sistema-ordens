...
const { atualizar } = require("../controllers/ordemController");
const { buscarPorId, excluir } = require("../services/ordemService");
...
const ordemModel = {
   ...
   async criar(dados){
     ...
     const {cliente_id, equipamento_id, tecnico_id, tipo_servico, problema, 
        diagnostico, solucao, detalhes, materiais, checklist } = dados;
        ...
        const[novaOrdem] = await db.query(
            ...
            [cliente_id, equipamento_id, tecnico_id || null, tipo_servico, problema || null,  diagnostico || null, solucao || null, detalhes || null, materiais || null, checklist || null]
        );
   ...
   async atualizar(id,dados){
    ...
    const {cliente_id, equipamento_id, tecnico_id, tipo_servico, problema, 
        ...
        const [ordemAtualizada] = await db.query(
            ...
            [cliente_id, equipamento_id, tecnico_id || null, tipo_servico, problema || null,
                diagnostico || null, solucao || null, detalhes || null, materiais || null,
                checklist || null, id]
        );
